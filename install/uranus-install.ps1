...
function Get-Registry {
    ...
    # Uranus: default to DockerHub tingchaopavilion
    return "docker.io/tingchaopavilion"
}
...
function Resolve-EmbeddedImage {
    ...
    $versioned = "$($script:HICLAW_REGISTRY)/uranus-embedded:$($script:HICLAW_VERSION)"
    $latestTag = "$($script:HICLAW_REGISTRY)/uranus-embedded:latest"
...
function Install-Manager {
    ...
    $script:CONTROLLER_IMAGE = if ($controllerImageOverride) {
        ...
        "$($script:HICLAW_REGISTRY)/uranus-controller:$($script:HICLAW_VERSION)"
    }
...
function Install-Worker {
    ...
    $workerImage = if ($env:HICLAW_INSTALL_WORKER_IMAGE) {
        ...
        "$registry/uranus-worker:$($script:HICLAW_VERSION)"
    }
