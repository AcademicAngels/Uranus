...
```bash
FIND_SKILLS_SCRIPT="${HERMES_HOME:-$HOME/.hermes}/skills/find-skills/scripts/hiclaw-find-skill.sh"
```
...
```
Install with ${HERMES_HOME}/skills/find-skills/scripts/hiclaw-find-skill.sh install <skill>
